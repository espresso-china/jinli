...
<div class="col-md-10 col-md-offset-1">
    <form class="form-horizontal layui-form" action="{{ route('platform.activity.store') }}" method="POST"
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8 col-md-8 col-xs-8">
                <input type="text" data-date="true" class="form-control" id="laydate" data-id="laydate" name="pubdate">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8 col-md-8 col-xs-8">
                {!! Form::select('floorid', $floors, old('floorid'),['class' => 'form-control select2']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8 col-md-8 col-xs-8">
                {!! Form::select('userid', $users, old('userid'),['class' => 'form-control select2']) !!}
            </div>
        </div>
        <div class="form-group">
            {!! Form::label('issms', '是否发送短信', ['class' => 'col-sm-3 col-md-3 control-label']) !!}
            <div class="col-lg-8 col-md-8 col-xs-8" >
                <input type="radio" name="issms" value="0" title="不发送" checked>
                <input type="radio" name="issms" value="1" title="发送" >
            </div>
        </div>
        <div class="form-group" id="smstpl">
            {!! Form::label('smstpl', '短信模版', ['class' => 'col-sm-3 col-md-3 control-label']) !!}
            <div class="col-lg-8 col-md-8 col-xs-8">
                {!! Form::textarea('smstpl','您已经报名***活动，24小时之内会有工作人员联系您！详询电话：***【腾讯大湘网】', ['class' => 'form-control','rows'=>3]) !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-8 col-md-8 col-xs-8">
                {!! Form::textarea('mark',old('mark',' '), ['class' => 'form-control','rows'=>3]) !!}
            </div>
        </div>
