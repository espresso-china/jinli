<div class="col-md-10 col-md-offset-1">
    <form class="layui-form form-horizontal" action="{{ route('platform.company.store') }}" method="POST">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    {!! Form::text('share_title', old('share_title'), ['class' => 'form-control']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    {!! Form::text('share_url', old('share_url'), ['class' => 'form-control','placeholder'=>'可为空，为空分享原文']) !!}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8 col-md-8">
                    <div class="input-group">
                        <input type="text" id="logo" name="share_img" value="" class="form-control" required="required">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8 col-md-8">
                    {!! Form::textarea('share_desc',old('share_desc'), ['class' => 'form-control','rows'=>3]) !!}
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-8 col-md-8" >
                    ...
                    <div class="">
                        <input type="radio" name="ismobile" value="1" checked title="有">
                        <input type="radio" name="ismobile" value="0"  title="无">
                    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8 col-md-8" >
                    <div class="">
                        <input type="radio" name="ispc" value="1" checked title="有">
                        <input type="radio" name="ispc" value="0"  title="无">
                    </div>
                </div>
            </div>
