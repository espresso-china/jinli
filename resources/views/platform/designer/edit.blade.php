...
<div class="col-md-10 col-md-offset-1">
    <form class="form-horizontal layui-form" action="{{ route('platform.designer.update',['id'=>$info->id]) }}" method="POST"
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <div class="input-group">
                    <input type="text" id="cover" name="cover" value="{!! $info->cover !!}" class="form-control"
                           required="required">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <div class="input-group">
                    <input type="text" id="cover2" name="ewm" value="{!! $info->ewm !!}" class="form-control" >
                    <span class="input-group-btn">
                                <button class="btn btn-primary waves-effect waves-light" data-file="one"
